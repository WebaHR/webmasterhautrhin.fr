...
export const metadata: Metadata = {
  title: "Création de site internet & e-commerce — Webmaster Haut-Rhin",
  description:
    "Sites vitrines et boutiques en ligne sur mesure pour les indépendants, les commerçants et les PME du Haut-Rhin. Design sobre, mobile, rapide. Devis gratuit.",
};
